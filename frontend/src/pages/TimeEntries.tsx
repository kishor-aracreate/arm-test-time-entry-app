    ...
    <Layout>
      <div className="space-y-6 bg-bg">
        ...
        <Card padding="none" className="shadow-lg shadow-shadow">
          <div className="flex flex-wrap gap-4 items-center bg-bg p-4 text-text">
            <div>
              ...
              <select
                ...
                className="border border-gray-300 rounded-md bg-bg px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
              >
            ...
            <div>
              ...
              <select
                ...
                className="border border-gray-300 text-text bg-bg rounded-md px-3 py-2 text-sm focus:outline-none"
              >
