...
const TimerBar: React.FC = () => {
  ...
  return (
    <div>
      <Card padding="none" className="border-0 shadow-lg shadow-shadow">
        <div className="space-y-6 bg-bg text-text p-4 sm:p-6">
          {/* Timer Display */}
          <div className="text-center">
            <div className="text-2xl sm:text-5xl lg:text-6xl font-mono text-blue-600 mb-2 sm:mb-4">
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500 text-base sm:text-sm transition-colors hover:cursor-pointer"
                  disabled={isLoading}
                >
